...
export default function Home() {
  ...
  const updateDistance = (value: string) => setFacts((current) => {
    ...
    return existing ? current.map((fact) => fact.field === "flight_distance_km" ? { ...fact, value: distance, confirmed: false } : fact) : [...current, { id: "distance", field: "flight_distance_km", label: "Flight distance", value: distance, provenance: "USER_STATED_UNCONFIRMED", sourceLabel: "You told Momo", confirmed: false }];
  });
