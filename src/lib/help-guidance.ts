...
export const helpGuides: Record<HelpTopic, HelpGuide> = {
  ...
  offer: { topic: "offer", screen: "result", title: "Let's look at the airline's offer", description: "Enter the cash, voucher, refund, or expense offer first. Momo will keep the amount and currency clear.", nextAction: "Add the offer details" },
